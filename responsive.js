...
document.addEventListener("DOMContentLoaded", () => {
    function fixStep3Height() {
        const step3 = document.getElementById("step3");
        if (window.innerWidth <= 768) {
            step3.style.maxHeight = window.innerHeight + "px";
            step3.style.overflowY = "auto";
        } else {
            step3.style.maxHeight = "";
            step3.style.overflowY = "";
        }
    }

    fixStep3Height();
    window.addEventListener("resize", fixStep3Height);
});
